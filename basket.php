    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <select onchange="location = this.value;" name=txtBuytype class="form-control col-sm-4" id="sel1">
          ...
          <option value="basket2.php">ชำระด้วยการโอนเงิน</option>
        </select>
        </div>
      </div><h1 align="right">ราคารวมทั้งหมด <?php echo number_format($SumTotal);?> บาท &nbsp;<a type="submit" class="btn btn-primary" href="basketcheckout.php?txtSumTotal=<?php echo $SumTotal?>" onclick="return confirm('คุณแน่ใจว่าจะสั่งซื้อสินค้าใช่หรือไม่');">สั่งซื้อสินค้า</a> <a class="btn btn-danger" href="deleteallbasket.php?Line=<?=$i;?>">ลบสินค้าทั้งหมด</a></h1>
