        ...
        <div>
          ...
          <div class="row">
            ...
            <table class="table">
                ...
                <?php $sql = "SELECT * FROM cp_reportrequestmoney INNER JOIN cp_user ON cp_reportrequestmoney.user_id = cp_user.user_id order by report_id desc";
                ...
                <tbody>
                  <tr>
                    ...
                    <?php if($result['report_status'] =='รอยืนยันโอนเงิน' OR $result['report_status'] =='โอนเงินไม่เรียบร้อย') { ?>
