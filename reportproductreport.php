...
<?php include "include/navbaradmin.php" ?>
    <div class="container">
      <div class="row">
        <div>
          <h1 class="page-header">รายงานสินค้าไม่เหมาะสม</h1>
          <div class="row">
            <table class="table">
                <thead>
                  <tr>
                ...
                <?php $sql = "SELECT * FROM cp_report INNER JOIN cp_product ON cp_report.pd_id = cp_product.pd_id INNER JOIN cp_user ON cp_report.user_id = cp_user.user_id order by report_id desc";
