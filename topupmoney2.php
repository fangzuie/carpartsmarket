...
<div class="jumbotron">
  ...
  <h1>ยืนยันเติมเงินใหม่</h1>
  <p>อัพโหลดใบสลิปโอนเงินเพื่อยืนยันการเติมเงินใหม่</p>
</div>
<div class="page-header">
  <h1>ยืนยันเติมเงินใหม่</h1>
</div>
<form class="form-horizontal" name="form2" method="post" action="confirmtopupmoneysave2.php" enctype="multipart/form-data">
