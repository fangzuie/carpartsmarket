...
date_default_timezone_set('Asia/Bangkok');
  ...
  $pdf->Ln(0);
  $pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','รายงานเติมเงินยูสเซอร์'),0,1,"L");
  $pdf->Ln(7);
  ...
  $pdf->Ln(12);
  $pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','ตารางรายงานรายงานเติมเงินยูสเซอร์'),0,1,"C");
  $pdf->Ln(6);
  ...
  $sql = "select * from cp_reporttopupmoney order by report_id desc";
