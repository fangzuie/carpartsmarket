        ...
        <div>
          ...
          <div class="row">
            ...
            <table class="table">
                ...
                <?php
                 $search = $_GET['search'];
                 $sql = "SELECT * FROM cp_reporttopupmoney INNER JOIN cp_user ON cp_reporttopupmoney.user_id = cp_user.user_id where cp_reporttopupmoney.report_status = '$search' order by report_id desc";
