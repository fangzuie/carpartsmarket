...
date_default_timezone_set('Asia/Bangkok');
  ...
  $pdf->Ln(0);
  $pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','รายงานอัพเดทสินค้าล่าสุด'),0,1,"L");
  $pdf->Ln(7);
  ...
  $pdf->Ln(12);
  $pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','ตารางรายงานรายงานอัพเดทสินค้าล่าสุด'),0,1,"C");
  $pdf->Ln(6);
  ...
  $pdf->Ln(8);
  $sql = "select * from cp_product order by pd_id desc";
