...
date_default_timezone_set('Asia/Bangkok');
  ...
  $pdf->Ln(0);
  $pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','รายงานเบิกเงินยูสเซอร์ตามวัน'),0,1,"L");
  $pdf->Ln(7);
  ...
  $pdf->Ln(12);
  $pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','ตารางรายงานรายงานเบิกเงินยูสเซอร์ตามวัน'),0,1,"C");
  $pdf->Ln(6);
  ...
  $sql = "select * from cp_reportrequestmoney where report_date like '%$reportdate%' order by report_id desc";
