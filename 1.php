...
date_default_timezone_set('Asia/Bangkok');
  ...
  $pdf->Ln(1);
  $pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','รายงานการเข้าใช้งานยูสเซอร์ล่าสุด'),0,1,"L");
  $pdf->Ln(8);
  ...
  $pdf->Ln(12);
  $pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','ตารางรายงานการเข้าใช้งานยูสเซอร์์ล่าสุด'),0,1,"C");
  $pdf->Ln(6);
  ...
  $pdf->Ln(8);
  $sql = "select * from cp_user order by user_lastupdate desc";
